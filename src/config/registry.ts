export const registryConfig = {
   ...
   * @example "https://shaiksha.dev/r/{name}.json" resolves to "https://shaiksha.dev/r/wheel-picker.json"
   ...
   */
  namespaceUrl:
    process.env.REGISTRY_NAMESPACE_URL || "https://shaiksha.dev/r/{name}.json",
};
